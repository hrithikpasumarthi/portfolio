...
export class NewdashboardComponent implements OnInit {
 ...
 ngOnInit(): void {
     this.is.getportfoliodata(localStorage.getItem('id')).subscribe((b)=>{this.data=b},(err)=>{console.log(err)},
     ()=>{this.aftercomplete()})
 }
 ...
 aftercomplete()
 {
  ...
  this.coverpic=this.data.coverpic;
  this.skills=this.data.skills;
  this.skillmap=this.data.skillmap;
  ...
  updatedata()
  {
    this.is.updateportfoliodata({id:localStorage.getItem('id'),profilepic:this.profilepic,coverpic:this.coverpic,skills:this.skills,
